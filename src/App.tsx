...
// array to hold all of the json team data
const teamNames = [
  {
    tid: 159,
    cid: 0,
...
// welcome function containing a heading that introduces the site
function Welcome() {
  return (
    <div>
      <h1>Happy March Madness Season!</h1>
      <h3>See a comprehensive list of all NCAA basketball colleges here.</h3>
    </div>
  );
}

// team class to be able to leas out each indiivudal team card
...
// function to list out each team in the array until there are no more left
function TeamList() {
  return (
    <div>
...
// main app functionality that will call the Welcome and Team functions
function App() {
  return (
    <div className="App">
